...
- 原项目中官方接口https://hailuoai.com/已更新，接口参数发生变化，API已经不可用了
- 原项目作者账号被封，无法更新了
...
进入iniMax-Agent随便发起一个对话，然后F12打开开发者工具，从Application > LocalStorage中找到_token的值，复制该值填写到Lobechat或者CherryStudio等工具中，作为API密钥，API地址是你部署应用的IP加端口，例如:`https://192.168.1.105:8001/v1/chat/completions`，注意某些工具只需要填写`https://192.168.1.105:8001/`即可。
